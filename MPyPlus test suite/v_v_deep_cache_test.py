# deep_benchmark_24.py
import time

# Dynamically create 24 nested classes L1 to L24
class L24:
    __slots__ = ('value',)
    def __init__(self):
        self.value = 42
...
def standard_deep(obj, iterations):
    ...
    for _ in range(iterations):
        total += obj.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.value
    return total

def pointer_cached_deep(ptr, iterations):
    root = *ptr
    # Cache the target after 23 dot operations
    target = root.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next.next
    total = 0
    for _ in range(iterations):
        total += target.value
    return total
