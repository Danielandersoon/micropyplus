...
def main():
	...
	while True:
		...
		print(
			"running totals us:",
			"std={} cache={}".format(std_total_us, cache_total_us),
		)
		print(
			"running avg us/access:",
			"std={:.2f} cache={:.2f}".format(std_total_avg_us, cache_total_avg_us),
		)
		print("checksum:", int(std_res), int(cache_res))
		...
		oled_lines(
			...
			[
				...
				"x{:.2f}".format(ratio),
				"tot s:{}ms".format(std_total_us // 1000),
				"tot c:{}ms".format(cache_total_us // 1000),
			],
		)
